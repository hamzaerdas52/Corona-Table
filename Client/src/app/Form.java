...
public class Form
{
    ...
    private JLabel dateLabel,testLabel,intensiveCareLabel,deathLabel,circumstanceLabel,recoveredLabel
            ,testTotalLabel,intensiveCareTotalLabel,deathTotalLabel,circumstanceTotalLabel,recoveredTotalLabel;
    ...
    private Form()
    {
        ...
        circumstanceLabel=new JLabel("Circumstance:");
        circumstanceLabel.setBounds(10,170,200,30);
        frame.add(circumstanceLabel);
        ...
        circumstanceTotalLabel=new JLabel("Circumstance Total:");
        circumstanceTotalLabel.setBounds(300,170,200,30);
        frame.add(circumstanceTotalLabel);
        ...
        try
        {
            ...
            while(true)
            {
                ...
                if(dataList.size()>0)
                {
                    ...
                    circumstanceLabel.setText("Circumstance:"+data.getCircumstance());
                    recoveredLabel.setText("Recovered:"+data.getRecovered());
                    int testTotal=0, intensiveCareTotal=0, deathTotal=0, circumstanceTotal=0, recoveredTotal=0;
                    for(Data data1: dataList)
                    {
                        ...
                        circumstanceTotal+=Integer.parseInt(data1.getCircumstance());
                    ...
                    circumstanceTotalLabel.setText("Circumstance Total:"+circumstanceTotal);
