...
public class Form
{
    ...
    private JTextField dateTextBox,testTextBox,intensiveCareTextBox,deathTextBox,circumstanceTextBox,recoveredTextBox;
    ...
    private Form()
    {
        ...
        circumstanceTextBox=new JTextField();
        circumstanceTextBox.setBounds(10,170,200,30);
        frame.add(circumstanceTextBox);
    ...
    private void onClick(ActionEvent actionEvent)
    {
        ...
        Data data=new Data(date,testTextBox.getText(),intensiveCareTextBox.getText(),deathTextBox.getText(),circumstanceTextBox.getText(),recoveredTextBox.getText());
        repository.add(data);
        update(data);
    }
